...
http://download.oracle.com/otn-pub/java/jdk/8u101-b13/jdk-8u101-linux-x64.tar.gz | sudo tar -xzf -C /opt
...
# install activemq
wget -qO- https://www.dropbox.com/s/2vwr0o4gv2xr1oc/apache-activemq-5.14.0-bin.tar.gz \
| sudo tar -xzf -C /opt
